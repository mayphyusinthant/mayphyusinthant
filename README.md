...
I develop robust and scalable applications using variety of backend technologies such as PHP Laravel, Laravel Jetstream, Python Flask, C#, .NET Framework, React Project depending on project scope and requirements.<br><br>
